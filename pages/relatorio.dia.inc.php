...
<h1>Relatório por dia do mês</h1>
...
var  loadData = function(query_search)
{
   $.ajax({
            type: "GET",
            url: "../../rest/grafico.dia.php?"+query_search,
            dataType: "text",
...
{
   var chart = new FusionCharts("../../fusioncharts/library/FCF_MSColumn2DLineDY.swf", "mg_chart", "780", "400", "0", "1", "","noScale","EN");
...
$(document).ready(function(){
   ...
   //-----------------------------------------------------------------------------
    ...
    {
        myColumnDefs = [
            {key:"vl_dia",         width: 250,  label:"Dia do Mês",  sortable:true                                           },
        ...
        myDataTable = new YAHOO.widget.DataTable("divTabelaDia", myColumnDefs,
