...
var  loadData = function(query_search)
{
   $.ajax({
            type: "GET",
            url: "../../rest/grafico.pizza.php?"+query_search,
            dataType: "text",
...
$(document).ready(function(){
   ...
   //-----------------------------------------------------------------------------
    ...
    {
        myColumnDefs = [
            {key:"nm_categoria",   width: 250, label:"Categoria",    sortable:true                                           },
...
<div id="divTabelaCategorias"></div>